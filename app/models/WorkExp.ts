...
export const workExps: WorkExp[] = [
    { title: "Freelance AI Consultant", company: "Horizon Media", years: "2025-present", description: "Automating company analysis through ChatGPT and Gemini", technologies: ["AI", "LLMs"] },
