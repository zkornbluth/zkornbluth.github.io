...
export const projects: Project[] = [
    ...
    { contributor: ProjectType.Mine, name: "Fantrax Baseball Contract Chart", technologies: ["React", "Selenium", "TypeScript", "Next.js"], description: "Plan your offseason moves", image: fantrax, github: "https://github.com/zkornbluth/fantrax-contract-chart", pageLink: "https://zkornbluth.github.io/fantrax-contract-chart" },
    ...
    { contributor: ProjectType.Contributed, name: "Map Poster Generator", technologies: ["Python", "Git"], description: "Fixed missing bays and straits", image: maptoposter, github: "https://github.com/zkornbluth/maptoposter" }
];