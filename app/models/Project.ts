...
export const projects: Project[] = [
    { contributor: ProjectType.Mine, name: "Wheel of Fortune Dashboard", technologies: ["R", "Shiny", "Cursor"], description: "Improve your Bonus Round puzzle solving", image: wheeloffortune, github: "https://github.com/zkornbluth/WheelOfFortune", pageLink: "http://zkornbluth.github.io/WheelOfFortune" },
    ...
    { contributor: ProjectType.Mine, name: "Fantrax Baseball Contract Chart", technologies: ["React", "Selenium", "Tailwind CSS", "Cursor"], description: "Plan your offseason moves", image: fantrax, github: "https://github.com/zkornbluth/fantrax-contract-chart", pageLink: "https://zkornbluth.github.io/fantrax-contract-chart" },
    ...
    { contributor: ProjectType.Mine, name: "Weather Widget", technologies: ["Python", "tkinter", "APIs", "Cursor"], description: "View real-time weather data by location", image: weather, github: "https://github.com/zkornbluth/weather_app" },
    { contributor: ProjectType.Mine, name: "Typing Speed Test", technologies: ["React", "TypeScript", "Tailwind CSS", "Cursor"], description: "Measure your words per minute & accuracy", image: typing, github: "https://github.com/zkornbluth/typing-test", pageLink: "https://zkornbluth.github.io/typing-test" },
