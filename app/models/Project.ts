...
export const projects: Project[] = [
    ...
    { contributor: ProjectType.Mine, name: "Typing Speed Test", technologies: ["React", "TypeScript", "Next.js", "Tailwind CSS"], description: "Measure your words per minute & accuracy", image: typing, github: "https://github.com/zkornbluth/typing-test", pageLink: "https://zkornbluth.github.io/typing-test" },
