...
export const projects: Project[] = [
    { contributor: ProjectType.Mine, name: "Wheel of Fortune Dashboard", technologies: ["R", "Shiny", "Cursor AI"], description: "Improve your Bonus Round puzzle solving", image: wheeloffortune, github: "https://github.com/zkornbluth/WheelOfFortune", pageLink: "http://zkornbluth.github.io/WheelOfFortune" },
    ...
    { contributor: ProjectType.Mine, name: "Strava Menu Bar Widget", technologies: ["Swift", "Strava", "Cursor AI"], description: "View your most recent workout", image: activity, github: "https://github.com/zkornbluth/ActivityBar" },
    { contributor: ProjectType.Mine, name: "Fantrax Baseball Contract Chart", technologies: ["JavaScript", "React.js", "Selenium", "Cursor AI"], description: "Plan your offseason moves", image: fantrax, github: "https://github.com/zkornbluth/fantrax-contract-chart", pageLink: "https://zkornbluth.github.io/fantrax-contract-chart" },
    ...
    { contributor: ProjectType.Mine, name: "To Do Manager", technologies: ["JavaScript","React.js", "TypeScript", "Next.js"], description: "Track your tasks with easy editing", image: todos, github: "https://github.com/zkornbluth/todo-manager", pageLink: "https://zkornbluth.github.io/todo-manager" },
    { contributor: ProjectType.Mine, name: "Weather Widget", technologies: ["Python", "tkinter", "APIs", "Cursor AI"], description: "View real-time weather data by location", image: weather, github: "https://github.com/zkornbluth/weather_app" },
    { contributor: ProjectType.Mine, name: "Typing Speed Test", technologies: ["React.js", "TypeScript", "Tailwind CSS", "Cursor AI"], description: "Measure your words per minute & accuracy", image: typing, github: "https://github.com/zkornbluth/typing-test", pageLink: "https://zkornbluth.github.io/typing-test" },
    ...
    { contributor: ProjectType.InReview, name: "Spotify Playlist Deduplicator", technologies: ["JavaScript", "TypeScript", "React.js", "Git"], description: "Improved song matching process", image: dedup, github: "https://github.com/zkornbluth/spotify-dedup" },
