...
const projects: Project[] = [
    ...
    new Project("Job Posting Filtering Tool", ["Python", "pandas"], "Scrape Indeed & LinkedIn with filtering options", jobsearcher, "https://github.com/zkornbluth/job_searcher"),
